...
import static com.xxx.car.flash.tts.api.constant.FlashUserOrderStatus.ORDER_CANCELED_BY_DRIVER;
...
@Component
@QFlashState(state = ORDER_CANCELED_BY_DRIVER, isFinalState = true)
public class FlashDriverCancelState extends AbstractFlashState {
